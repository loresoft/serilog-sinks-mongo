...
public class ConfigCommand : Command
{
    ...
    public const string CommandDescription = "Use MongoDB configured from appsettings.json";
    ...
    public static async Task<int> ExecuteAsync(ParseResult parseResult, CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("MongoDB Collection: logs-config (from configuration)");
